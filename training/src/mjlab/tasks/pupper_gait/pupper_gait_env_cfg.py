...
BUMPY_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    curriculum=False,
    sub_terrains={
        "bumpy": perlin_noise(proportion=1.0, height_range=(0.0, 0.05))
    },
    add_lights=True,
)
...
def _add_gait(
    ...
    if shared_critic:
        ...
        cfg.observations["critic"].terms["gait_reference"] = (
            ObservationTermCfg(
    ...
    if play or yaw_stages is None:
        ...
        cfg.curriculum["command_vel"] = CurriculumTermCfg(
            ...
            params={
                ...
                "velocity_stages": [
                    {
                        "step": iters * GAIT_STEPS_PER_ITER,
                        "ang_vel_z": (-mag, mag),
                    }
    ...
    if not play:
        ...
        cfg.events["hold_base_airborne"] = EventTermCfg(
            ...
            params={
                "height": GAIT_PRETRAIN_HEIGHT,
                "until_step": pretrain_steps,
            },
        )
...
def pupper_mixed_gaits_bumpy_env_cfg(
    play: bool = False,
) -> ManagerBasedRlEnvCfg:
...
def pupper_stable_gait_bumpy_env_cfg(
    play: bool = False,
) -> ManagerBasedRlEnvCfg:
